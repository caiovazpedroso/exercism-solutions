...
def recite(start_verse, end_verse):
    ...
    if end_verse == start_verse:
        song = f'On the {days[end_verse-1]} day of Christmas my true love gave to me:{verse[12 - start_verse]}.'
    else:
        thing = ''
        i = 0
        while i < (end_verse - start_verse):
            ...
            i += 1
        song = f'On the {days[end_verse-1]} day of Christmas my true love gave to me:{thing} and{verse[12 - start_verse]}.'
    if song[-2] == ',':
        final_song = song[0:-2] + '.'
    else:
        final_song = song
